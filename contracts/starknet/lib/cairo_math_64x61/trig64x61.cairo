...
namespace Trig64x61 {
    ...
    func sin{range_check_ptr}(x: felt) -> (res: felt) {
        alloc_locals;
    ...
    func cos{range_check_ptr}(x: felt) -> (res: felt) {
    ...
    func tan{range_check_ptr}(x: felt) -> (res: felt) {
        alloc_locals;
    ...
    func atan{range_check_ptr}(x: felt) -> (res: felt) {
        alloc_locals;
        ...
        local x1b_num = x1a - b;
        let (x1b_div_2) = Math64x61.mul(x1a, b);
        tempvar x1b_div = Math64x61.ONE + x1b_div_2;
    ...
    func asin{range_check_ptr}(x: felt) -> (res: felt) {
        alloc_locals;
    ...
    func acos{range_check_ptr}(x: felt) -> (res: felt) {
        alloc_locals;
    ...
    func _sin_loop{range_check_ptr}(x: felt, i: felt, acc: felt) -> (res: felt) {
        alloc_locals;
