...
@external
func test_skip_elements{syscall_ptr: felt*, range_check_ptr}() {
    alloc_locals;
    ...
    let (_volatility) = ISummaryStats.calculate_volatility(
        summary_stats_address, 1, 1664805721, 1664806093, 5
    );
    assert _volatility = 3609195700;  // returns value in decimals
    let (_volatility) = ISummaryStats.calculate_volatility(
        summary_stats_address, 1, 1664805720, 1664806094, 3
    );
    assert _volatility = 5585384300;  // returns value in decimals
