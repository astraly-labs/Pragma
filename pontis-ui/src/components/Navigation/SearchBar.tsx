...
const SearchBar: React.FC = () => {
  ...
  return (
    <button
      type="button"
      className="flex h-12 w-full items-center space-x-3 rounded-lg bg-white px-4 text-left text-slate-500 shadow-sm ring-1 ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 sm:w-60"
