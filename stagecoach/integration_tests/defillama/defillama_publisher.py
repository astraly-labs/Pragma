...
from empiric.publisher.fetchers import DefillamaFetcher
...
async def main():
    ...
    llama_fetcher = DefillamaFetcher(EMPIRIC_ALL_ASSETS, publisher)
    publisher_client.add_fetcher(llama_fetcher)
