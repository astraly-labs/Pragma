...
import  { hexToUtf8,extractDescriptionFromClaim, extractTitleFromClaim } from "../utils";
...
const fetchData = useCallback(async (type: string, pageNumber: number, loadMore: boolean = false) => {
  try {
    setLoading(true);
...
return (
  <StarknetProvider connectors={connectors}>
    ...
    >
      ...
      />
      <BoxContainer>
        <ActiveAssessments assessments={items} loading={loading} onAssertionTypeChange={handleAssertionTypeChange}  onLoadMore={handleLoadMore} hasMore={hasMore}
        />
      </BoxContainer>
    </div>
    </StarknetProvider>
