    ...
    <BoxContainer className={classNames(styles.bigScreen, "2xl:pl-20")}>
      <div className="flex flex-col gap-7 ">
        ...
        <div className="font-mono tracking-wider text-lightGreen">
          ...
          website or which we otherwise receive or collect from you in the
          course of, or in connection with, your use of our site located at
          https://pragma.build and all associated sites (the “Website”), the
          pursuit of our mission to (our “Services”) and our operations. Please
          ...
          internally in connection with the Website and our Services, including
          to provide, and improve our services, to contact you, to fulfill your
          requests for certain products and services, and to analyze how you use
          the Website and the Services. In certain cases, we may also share some
          Personal Information with third parties, but only as described below.
          By using the Website and our Services, you consent to the collection
          of this information and the uses and disclosures described in this
          policy and the Terms. We do not knowingly collect or solicit Personal
          Information from anyone under the age of 13. If you are under 13,
          please do not attempt to send any Personal Information about yourself
          to us. If we learn that we have collected Personal Information from a
          child under age 13, we will delete that information as quickly as
          ...
          example, you share information directly with us when you fill out a
          form, submit or post content through our Services, make a purchase,
          communicate with us via third-party platforms, participate in a
          contest or promotion, request customer support, or otherwise
          ...
          information about your online activity after you leave the Website.
          Just like any other usage information we collect, this information
          allows us to improve the Website and the Services, and is otherwise
          used as described in this Privacy Policy. Your browser may offer you a
          “Do Not Track” option, which allows you to signal to operators of
          ...
          websites. Our Website does not support Do Not Track requests at this
          time, which means that we collect information about your online
          activity both while you are using the Website or the Services and
          after you leave. <br /> <br />
          <h5 className="text-mint">
            HOW DOES THE FOUNDATION USE MY INFORMATION?
          </h5>{" "}
          <br /> We use the Personal Information we collect to maintain, and
          improve our Services and Website. We also use the Personal Information
          we collect to:
          <br />
          <br />
          <div className="pl-8">
            ...
            <br /> <br /> - Process transactions and send you related
            information, including confirmations, receipts, invoices, customer
            experience surveys, and notices; <br /> <br /> - Send you technical
            notices, security alerts, and support and administrative messages;{" "}
            <br /> <br /> - Respond to your comments and questions and provide
            customer service; <br /> <br /> - Monitor and analyze trends, usage,
            and activities in connection with our Services;
            <br /> <br /> - Personalize the advertisements you see on
            third-party platforms and websites (for more information, see the
            Your Choices section below);
            <br /> <br /> - Facilitate contests, sweepstakes, and promotions and
            process and deliver entries and rewards;
            <br /> <br /> - Detect, investigate, and prevent security incidents
            and other malicious, deceptive, fraudulent, or illegal activity and
            protect the rights and property of the Foundation and others;
            <br /> <br /> - Debug to identify and repair errors in our Services;
            <br /> <br /> - Comply with our legal and financial obligations;
            <br /> <br /> - and Carry out any other purpose described to you at
            the time the information was collected.
          </div>
          <br /> <br />
          <h5 className="text-mint">
            WILL THE FOUNDATION SHARE ANY OF THE PERSONAL INFORMATION IT
            RECEIVES?
          </h5>{" "}
          <br />
          ...
          often and in what ways people use our Services, so that they, too, can
          provide you with an optimal online experience. However, we never
          disclose aggregate usage or de-identified information to a partner (or
          allow a partner to collect such information) in a manner that would
          identify you as an individual person. <br /> <br />
          <span className="font-bold text-mint opacity-50">
          ...
          services to you; for example, we may use a payment processing company
          ...
          If you are a member of a Pragma Network community group, members known
          as Community Advocates may have access to the content within their
          ...
          transferred to or acquired by a third party. Protection of the
          <br /> <br />
          <span className="font-bold text-mint opacity-50">
            Foundation and others:
          </span>{" "}
          We reserve the right to access, read, preserve, and disclose any
          information that we believe is necessary to comply with law,
          regulation or court order; enforce or apply our Terms of Service and
          other agreements; or protect the rights, property, or safety of the
          Foundation, our users, or other persons. <br /> <br />
          <h5 className="text-mint">
            TRANSFERS OF INFORMATION TO OTHER COUNTRIES
          </h5>{" "}
          <br />
          We have operations and service providers in other countries, including
          countries outside of the European Economic Area (EEA). Therefore, we
          and our service providers may transfer your Personal Information to,
          ...
          jurisdiction. We will take steps to ensure that your Personal
          Information receives an adequate level of protection in the
          jurisdictions in which we process it. <br /> <br />
          <h5 className="text-mint">YOUR CHOICES</h5> <br />
          <span className="font-bold text-mint opacity-50">Cookies.</span> Most
          ...
          cookies. Please note that removing or rejecting cookies could affect
          the availability and functionality of our Services.
          <br /> <br />
          <span className="font-bold text-mint opacity-50">
            Communication Preferences.
          </span>{" "}
          You may opt out of receiving promotional emails from the Foundation by
          following the instructions in those communications or by emailing us
          at{" "}
          <Link
            className="text-mint underline"
            href={"mailto:legal@pragma.build"}
          ...
          as those about our ongoing business relations.
          <br /> <br />
          <span className="font-bold text-mint opacity-50">
          ...
          to collect information about your use of our Website and Services and
          other websites and applications, including your IP address, web
          ...
          be used by the Foundation and others to, among other things, analyze
          and track data, determine the popularity of certain content, deliver
          ...
          visit www.aboutads.info/choices Your device may also include a feature
          (“Limit Ad Tracking” on iOS or “Opt Out of Interest-Based Ads” or “Opt
          Out of Ads Personalization” on Android) that allows you to opt out of
          having certain information collected through mobile apps used for
          behavioral advertising purposes. <br /> <br />
          We also work with third parties to serve ads to you as part of
          customized campaigns on third-party platforms (such as Reddit). As
          part of these ad campaigns, we or the third-party platforms may
          convert information about you, such as your activity information, into
          a unique value that can be matched with a user account on these
          platforms to allow us to learn about your interests and serve you
          advertising that is customized to your interests. Note that the
          ...
          <br /> If you are located in the EEA, the United Kingdom, or
          Switzerland, you have certain rights and protections under the law
          regarding the processing of your Personal Information, and this
          section applies to you. <br /> <br />
          <span className="font-bold text-mint opacity-50">
            Legal Basis for Processing:
          </span>{" "}
          When we process your Personal Information, we will do so in reliance
          on the following lawful bases:
          <div className="pl-8">
            <br />
            - To perform our responsibilities under our contract with you (e.g.,
            processing payments for and providing the Services you requested).
            <br /> <br />
            ...
            <br /> <br /> - To comply with our legal obligations (e.g., to
            maintain a record of your consents and track those who have opted
            out of marketing communications).
            <br /> <br />- When we have your consent to do so (e.g., when you
            opt in to receive marketing communications from us). When consent is
            the legal basis for our processing of your Personal Information, you
          ...
          If you have a concern about our processing of Personal Information
          that we are not able to resolve, you have the right to lodge a
          complaint with the Data Protection Authority where you reside. Contact
          details for your Data Protection Authority can be found using the
          links below:
          <br /> <br /> For individuals in the EEA:
          ...
          <br /> <br />
          <h5 className="text-mint">
            CERTAIN INFORMATION FOR CALIFORNIA RESIDENTS
          </h5>{" "}
          <br />
          ...
          California resident, this section applies to you. <br /> <br />
          <span className="font-bold text-mint opacity-50">
          ...
          or electronic network activity information, professional or employment
          related information, education information, financial information, and
          information derived from other personal information about you. For
          details about the precise data points we collect and the categories of
          sources of such collection, please see the Collection of Information
          section above. We collect Personal Information for the business and
          commercial purposes described in the Use of Information section above.
          ...
          <div className="pl-8">
            <br />
            - Identifiers;
            <br /> <br />- Commercial Information;
            <br /> <br />- Internet or other electronic network activity
            information;
            <br /> <br />- Professional or employment information;
            <br /> <br />- Education information; Financial information;
            <br /> <br />- and Information derived from other personal
          ...
          <div className="pl-8">
            <br />
            - Partners, including vendors and service providers;
            <br /> <br />- Companies under common control and ownership; and
            <br /> <br />- Apps, websites, and third-party integrations on or
            using our Website or Services. <br />
            <br />
          </div>{" "}
          The Foundation does not sell your personal information. We do allow
          our advertising partners to collect certain electronic network
          activity via our Website and Services to show ads that are targeted to
          your interests. To opt out of having your Personal Information used
          for targeted advertising purposes, please see the Your Choices section
          above. Subject to certain limitations, you have the right to (1)
          request to know more about the categories and specific pieces of
          personal information we collect, use, and disclose, (2) request
          deletion of your personal information, and (3) not be discriminated
          against for exercising these rights. You may make these requests by
          emailing{" "}
          <Link
            className="text-mint underline"
            href={"mailto:legal@pragma.build"}
          ...
          <br /> Subject to certain limitations, you have the right to request
          access to the Personal Information we hold about you and to receive
          your data in an accessible and portable format, the right to ask that
          your Personal Information be corrected or erased, and the right to
          object to, or request that we restrict, certain processing. If you
          would like to exercise any of these rights, please email us at{" "}
          <Link
            className="text-mint underline"
            href={"mailto:legal@pragma.build"}
          >
          ...
          . We store Personal Information for as long as necessary to carry out
          the purposes for which we originally collected it and for other
          legitimate business purposes, including to meet our legal, regulatory,
          or other compliance obligations. <br /> <br />
          <h5 className="text-mint">
            WHAT IF I HAVE QUESTIONS ABOUT THIS POLICY?
          </h5>{" "}
          <br /> If you have any questions or concerns regarding this Privacy
