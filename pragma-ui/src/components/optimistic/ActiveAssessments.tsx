              ...
              <Listbox value={selectedOption} onChange={handleOptionChange}>
                <div className="relative w-full md:w-auto">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                  >
                    <Listbox.Options className="absolute z-20 mt-1 max-h-60 w-full overflow-auto rounded-md bg-green py-1 text-sm text-lightGreen ring-1 backdrop-blur focus:outline-none">
